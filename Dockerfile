# Dockerfile for building Moonlight Qt
# Supports building Linux AppImage and development builds
...
# Note: Source code is mounted as a volume, so no COPY commands needed
CMD ["/bin/bash"]
